...
class AtsDomDryRunResult:
    status: ApplicationStatus
    dry_run: FormDryRunResult | None = None
    reason: str | None = None


class AtsDomDryRunAdapter:
    def __init__(self, repository, *, ats_type: str, real_submission_enabled: bool = False) -> None:
    ...
    def submit(self) -> None:
        ...
        raise RuntimeError(f"{self.ats_type} dry-run adapter must never submit")
